...
class AlertCode(Enum):
    ...
    # WARN: This line of the marker block does not have the indentation of the
    # first marker. Each marker and the completion token must be aligned.
    MARKER_NOT_ALIGNED = 116

    # WARN: The lines of the marker block do not have the same number of
    # slashes. e.g. a "///" marker with a "//" nameref comment.
